...
#define LCD_DATA_LAT                   LCD_DATA_LATCH
//#define LCD_DATA_TRIS                  LCD_DATA_TRIS  // [SW] this define is set in global.h

#define LCD_RSSignal_Set()        LCD_RS_LATCH = 1 //set Register Select bit
#define LCD_RSSignal_Clear()      LCD_RS_LATCH = 0 //clear Register Select bit

#define LCD_RWSignal_Set()        LCD_RW_LATCH = 1  //set Read/Write bit
#define LCD_RWSignal_Clear()      LCD_RW_LATCH = 0  //clear Read/Write bit

#define LCD_EnableSignal_Set()    LCD_EN_LATCH = 1  //set Enable bit
#define LCD_EnableSignal_Clear()  LCD_EN_LATCH = 0  //clear Enable bit

#define LCD_RSSignal_Input()      LCD_RS_TRIS = 1 //set Register Select bit
#define LCD_RSSignal_Output()     LCD_RS_TRIS = 0 //clear Register Select bit

#define LCD_RWSignal_Input()      LCD_RW_TRIS = 1  //set Read/Write bit
#define LCD_RWSignal_Output()     LCD_RW_TRIS = 0  //clear Read/Write bit

#define LCD_EnableSignal_Input()  LCD_EN_TRIS = 1  //set Enable bit
#define LCD_EnableSignal_Output() LCD_EN_TRIS = 0  //clear Enable bit
